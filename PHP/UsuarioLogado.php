...
<header>
    ...
    <div class="nav-user">
      <ul>
        ...
        <li><button class="btn-menu" id="BtnMenu">MENU</button></li>
      </ul>
    </div>
</header>
...
<section class="main">
  <nav class="nav-side" id="menu">
    <div class="user-avatar">
      <div class="user-avatar-img">
        <img src="<?php echo htmlspecialchars($user_avatar); ?>" alt="Avatar do usuário">

      </div>
      <span><?php echo $_SESSION['user_name']; ?></span>
    </div>
    <ul>
      <li><a href="?feed=foryou">Página inicial</a></li>
  ...
  <section class="navigation-user" id="NavigationUser">
    <div class="initial-options">
      <ul>
        <li><a href="?feed=foryou" <?php if($tipo_feed==='foryou') echo 'class="active"'; ?>>Para Você</a></li>
        <li><a href="?feed=seguindo" <?php if($tipo_feed==='seguindo') echo 'class="active"'; ?>>Seguindo</a></li>
      </ul>
    </div>
    <div class="conteudo">
      <?php if($tipo_feed === 'seguindo'){echo $no_seguindo;} ?>
      <?php if($tipo_feed === 'foryou'){echo $no_obras;} ?>
      <?php while ($post = $result->fetch_assoc()) { ?>
        ...
        <article class="posts">
          ...
          <div class="descricao-post">
           <span class="nome-desc">User: <?php echo htmlspecialchars($post['nome_user']); ?></span>
