...
<body>
  ...
  <nav class="nav-side" id="menu">
    ...
    <ul class="pages">
      ...
      <li><a class="selecionado" href="Galeria.php"><i class="fi fi-br-picture"></i>Galeria</a>
      </li>
  ...
  <section class="galeria-main">

    <div class="galeria-header-sticky">
      <h1 class="tituloG">Galeria</h1>
      <div class="galeria-categorias" id="galeria-categorias">
        ...
        <?php else: ?>
          <?php foreach ($tags as $tag): ?>
            <button data-cat="<?php echo htmlspecialchars($tag); ?>"
              class="cat-btn"><?php echo htmlspecialchars($tag); ?></button>
          <?php endforeach; ?>
        <?php endif; ?>
      </div>
    </div>
