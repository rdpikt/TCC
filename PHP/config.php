...
<body>
  ...
  <nav class="nav-side" id="menu">
    ...
    <div class="tools">
      <ul>
        <li><a class="selecionado" href="config.php"><i class="fi fi-rr-settings"></i>Configurações</a></li>
  ...
  <main class="main">
    <section class="content">
      <form action="config.php" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="alterar_nome" id="AlterarNome" placeholder="Alterar seu Nome">
        
        <textarea name="alterar_bio" id="AlterarBio" placeholder="Mude sua bio" style="resize: none"></textarea>

        <input type="submit" value="Salvar alterações">
      </form>
    </section>
  </main> <div class="modal-overlay"></div>
